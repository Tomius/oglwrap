...
public:
   ...
   * @version 1.0
   */
  static void BlendEquation(enums::BlendEquation eq) {
   ...
   * @version 4.0
   */
  static void BlendEquation(GLuint buffer, enums::BlendEquation eq) {
   ...
   * @version 2.0
   */
  static void BlendEquationSeparate(enums::BlendEquation mode_rgb,
   ...
   * @version 4.0
   */
  static void BlendEquationSeparate(GLuint buffer, enums::BlendEquation mode_rgb,
                                    enums::BlendEquation mode_a) {
   ...
   * @version 1.0
   */
  static void BlendFunc(enums::BlendFunction src, enums::BlendFunction dst) {
   ...
   * @version 4.0
   */
  static void BlendFunc(GLuint buffer, enums::BlendFunction src,
   ...
   * @version 1.4
   */
  static void BlendFuncSeparate(enums::BlendFunction src_rgb,
   ...
   * @version 4.0
   */
  static void BlendFuncSeparate(GLuint buffer,
   ...
   * @version 1.0
   */
  static void glBlendColor(glm::vec4 blend_color) {
   ...
   * @version 1.0
   */
  static void glBlendColor(GLfloat red, GLfloat green,
