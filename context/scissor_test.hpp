...
#ifndef OGLWRAP_CONTEXT_SCISSOR_TEST_HPP_
#define OGLWRAP_CONTEXT_SCISSOR_TEST_HPP_
...
/// Wrapper for the ScissorBuffer related operations.
class ScissorTest {
public:
  /**
   ...
   * @version OpenGL 4.1
   */
  static void Scissor(GLuint viewport, GLint left, GLint bottom,
   ...
   * @version OpenGL 4.1
   */
  static void ScissorArray(GLuint first, GLuint count, GLint *v) {
   ...
   * @version OpenGL 4.1
   */
  static glm::ivec4 ScissorBox(GLuint viewport) {
    GLint data[4];
