...
inline TextureBinding GetBindingTarget(TextureTarget type) {
  ...
  switch (type) {
    ...
    case TextureTarget::kTextureRectangle:
    ...
    case TextureTarget::kTexture1DArray:
    ...
    case TextureTarget::kTexture2DArray:
    ...
    case TextureTarget::kTextureCubeMap:
